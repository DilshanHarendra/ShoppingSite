...
class refundPayment extends Component {
  ...
  render() {
    return (
      <div>
        <Container>
          <h1 className="my-auto mx-auto text-center text-dark">
            PAYMENT-REFUND
          </h1>
          <h6 className="my-3 mx-auto text-center text-dark">
            Make sure, only for card payments can be raised a refund request
          </h6>
          <Table responsive="md">
            <thead>
              <tr>
